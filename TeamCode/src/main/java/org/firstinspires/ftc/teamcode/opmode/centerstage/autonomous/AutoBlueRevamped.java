...
@Autonomous(name = "bad blue autonomy better")
public class AutoBlueRevamped extends LinearOpMode {
    ...
    private PatternDetectionTest.ObjectPosition op = PatternDetectionTest.ObjectPosition.MIDDLE;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        PatternDetectionTest p = new PatternDetectionTest();
...
//        visionPortal = VisionPortal.easyCreateWithDefaults(hardwareMap.get(WebcamName.class, "Webcam 1"), bluePropProcessor);
        ...
        while (!isStarted()) {
            location = PatternDetectionTest.convertB(op);
            if (location==LEFT){
                randomization = 2;
