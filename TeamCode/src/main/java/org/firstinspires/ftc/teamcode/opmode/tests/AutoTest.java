...
public class AutoTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d leftProp = new Pose2d(-40, -32, Math.toRadians(-90));
        Pose2d stackPos = new Pose2d(-45, -15, Math.toRadians(-180));
        Pose2d rightProp = new Pose2d(-32, -40, Math.toRadians(0)); //rn

        Pose2d rightPropIntermediate = new Pose2d(-28, -40, Math.toRadians(0)); //rn
        Pose2d middleProp = new Pose2d(-30, -20, Math.toRadians(-90));
        Pose2d middlePropIntermediate = new Pose2d(-35,-5, Math.toRadians(-90));
        Pose2d middlePropIntermediate2 = new Pose2d(-35.1, -5, Math.toRadians(-180));
        Pose2d propDir[] = {leftProp, middleProp, rightProp};
        Pose2d afterPropID = new Pose2d(-35, -11.6, Math.toRadians(-90));
        Vector2d beforeYellow = new Vector2d(25, -11.6);
        double depoAngle[] = {Math.toRadians(-165), Math.toRadians(-180), Math.toRadians(-195)};
        ...
        Trajectory middleIntermediate = drive.trajectoryBuilder(toProp.end())
                .lineToLinearHeading(middlePropIntermediate)
                .build();

        Trajectory stackPosition = drive.trajectoryBuilder(middleIntermediate.end())
                .lineToLinearHeading(stackPos)
                .build();

        Trajectory rightIntermediate = drive.trajectoryBuilder(toProp.end())
                .lineToLinearHeading(rightPropIntermediate)
                        .build();



//        Trajectory middleIntermediate2 = drive.trajectoryBuilder()
...
//            drive.followTrajectory(rightIntermediate);
            ...
            drive.followTrajectory(stackPosition);
            sleep(500000);
        }
    }
    public void eject(){
