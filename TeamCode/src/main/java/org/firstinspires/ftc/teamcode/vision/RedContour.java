...
public class RedContour extends OpenCvPipeline
{
    Telemetry telemetry;
    ...
    public Mat processFrame(Mat input)
    {
        ...
        telemetry.addLine(String.valueOf(area_left));
        telemetry.addLine(String.valueOf(area_middle));
        telemetry.addLine(String.valueOf(area_right));
    ...
    public double find_largest_red_area(Mat roi_hsv){
        Scalar lower_red = new Scalar(0, 50, 30); //0 100 70
        Scalar upper_red = new Scalar(13, 225, 225); //10 255 255
